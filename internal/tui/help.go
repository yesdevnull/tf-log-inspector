...
var helpGroups = func() []helpGroup {
	...
	return []helpGroup{
		...
		{title: "EVERYWHERE", entries: []helpEntry{
			...
			{keys: "d / M", what: "diagnostics / observed milestones"},
			{keys: "/ f s", what: "event panels: search / kind / severity filters"},
			{keys: "Space", what: "event panels: expand or collapse a group"},
			{keys: "Enter r", what: "event panels: source / resource history; Esc returns"},
			{keys: "x", what: "event panels: export current investigation as Markdown or JSON"},
