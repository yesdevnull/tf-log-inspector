...
func writeCaptureQuality(b *strings.Builder, q model.CaptureQuality) {
	...
	if captureHasIssue(q.Issues, "context", "context_incomplete") {
...
func captureHasIssue(issues []model.QualityIssue, stage, code string) bool {
