...
C1 was implemented and verified through signed commit `f5b4165` on `wip/capture-evidence` before C2 began. C2 is now complete; its [execution evidence](2026-09-10-capture-quality-presentation.md#execution-evidence--10-september-2026) records the combined branch's final checks and review. The checked steps above record completed behaviour and verification; the chronology qualifications below are part of that record.
